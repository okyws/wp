...
<div data-enabled="<?php echo oasis_footer_parallax_is_enabled();?>" data-colibri-component="footer-parallax" data-colibri-id="17-f1" class="page-footer style-62 style-local-17-f1 position-relative">
